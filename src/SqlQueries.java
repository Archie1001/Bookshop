public interface SqlQueries {
    ...
    String QUERY_FOR_GET_ALL_BOOKS = "SELECT Book_id, Title, Author_first_name, Author_last_name, Genre, Publication_date, Available_books FROM BOOKS";
    ...
    String QUERY_GET_ALL_AVAILABLE_BOOKS = "SELECT LIST_OF_BOOKS.List_id, LIST_OF_BOOKS.Book_id, LIST_OF_BOOKS.Price, BOOKS.Title, BOOKS.Available_books " +
            "FROM LIST_OF_BOOKS JOIN BOOKS ON LIST_OF_BOOKS.Book_id = BOOKS.Book_id WHERE Available_books != 0 ";
    String QUERY_SET_NUMBER_OF_AVAILABLE_BOOKS = "UPDATE BOOKS SET Available_books = ? WHERE Book_id = ?";
}
